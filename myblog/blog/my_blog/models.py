...
class AboutAuthor(models.Model):
    name = models.CharField(verbose_name='作者姓名', max_length=200)
    img_url = models.CharField('头像', max_length=200)
    job = models.CharField('岗位信息', max_length=200)
    description = models.CharField('个人简介', max_length=500)
