    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_url', models.CharField(max_length=200, verbose_name='头像')),
                ('job', models.CharField(max_length=200, verbose_name='岗位信息')),
                ('description', models.CharField(max_length=500, verbose_name='个人简介')),
            ],
            options={
                'verbose_name': '作者介绍',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='my_blog.Category', verbose_name='文章分类')),
                ('keywords', models.ManyToManyField(help_text='文章关键词，用来作为SEO中keywords，最好使用长尾词，3-4个足够', to='my_blog.Keyword', verbose_name='文章关键词')),
